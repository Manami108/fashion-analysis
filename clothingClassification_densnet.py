...
#   pretrained the model DensNet-121 was loaded , and replace fully connected layer with a custom sequential module. 
    ...
    # Using label smoothing in the CrossEntropyLoss (requires PyTorch 1.10+)
